...
/**
 * @title DAOBoxGovernor
 * @dev The main governance contract managing the voting logic.
 */
contract DAOBoxGovernor is Governor, GovernorSettings, GovernorCountingSimple, GovernorVotes, GovernorVotesQuorumFraction, GovernorTimelockControl {
    constructor(IVotes _token, TimelockController _timelock)
        Governor("DAOBoxGovernor")
